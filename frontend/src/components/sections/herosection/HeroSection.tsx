...
export default function HeroSection() {
  ...
  return (
    <HeroRoot aria-labelledby="hero-heading">
      <HeroLeft>
        <Eyebrow aria-hidden="true">{dict.hero.eyebrow}</Eyebrow>
        ...
        <HeroCta>
          <BtnFill href="#experience">{dict.hero.myWork}</BtnFill>
          <BtnOutline href="#contact">{dict.hero.letsTalk}</BtnOutline>
        </HeroCta>
      </HeroLeft>
      <HeroRight aria-hidden="true">
        <Image
